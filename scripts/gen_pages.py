...
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-BY93CRYSZK"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){{dataLayer.push(arguments);}}
  gtag('js', new Date());
  gtag('config', 'G-BY93CRYSZK');
</script>
<meta charset="UTF-8">
...
PAGES = [
  ...
  dict(slug="couple-games", em_word="Games",
    title="Couple Games — 12 Fun Games for Couples to Play | iLovu",
    desc="Couple games for two &mdash; fun, easy games for couples to play at home, over text or on date night, from would you rather to the 36 questions and the newlywed game.",
    og="Fun Couple Games to Play Together",
    eyebrow='<a href="/date-ideas">For couples</a> &middot; Games',
    h1='Couple Games That Are Actually <em>Fun to Play</em>',
    lead="The best couple games do one thing: get you talking and laughing about each other. No board required &mdash; here are twelve games for couples to play at home, on a car journey, or on date night.",
    ideas=[("🤔","Would you rather","Trade this-or-that questions and see how in sync you are. Play a new one daily in the <a href='/would-you-rather-couples'>iLovu Would You Rather game</a>.","Free"),
      ("💬","The 36 questions","The <a href='/36-questions'>36 questions that make two people fall in love</a> &mdash; take turns, go in order, don't skip.","Free"),
      ("🎭","Two truths and a lie","Three statements, one false. Even years in, you'll still get caught out.","Free"),
      ("💍","The newlywed game","'Who's more likely to&hellip;' Write your answers, reveal together, argue happily.","Free"),
      ("🙅","Never have I ever","Take turns confessing. A surprisingly fast way to learn new things about each other.","Free"),
      ("🎯","Guess my answer","One asks a question, the other guesses how they'll answer before they say it.","Free"),
      ("🫙","The question jar","Fill a jar with questions and pull one at dinner every night.","Low cost"),
      ("🔢","20 questions","One thinks of something, the other has twenty yes/no guesses. Loser does the dishes.","Free"),
      ("🃏","Card game night","Learn a two-player card game neither of you knows and fumble the rules together.","Low cost"),
      ("🧠","How well do you know me","Quiz each other on favourites, firsts and pet peeves. Keep score.","Free"),
      ("📖","One-line story","Build a story one sentence each. It always ends somewhere ridiculous.","Free"),
      ("✏️","Blind portrait","Draw each other without looking at the paper. Frame the worst one.","Low cost")],
    cta_h2="Play a new one every single day",
    cta_p=("iLovu has a daily <strong>Would You Rather</strong>, a daily question, and the full 36 Questions built in "
           "&mdash; you both answer, then see if you match. Plus 190+ date ideas for when you're ready to go out."),
    faqs=[("What are good games for couples to play?","Talking games win: would you rather, the 36 questions, two truths and a lie, the newlywed 'who's more likely to' game, and 20 questions. They need nothing but the two of you."),
      ("What games can couples play at home or over text?","Would you rather, never have I ever, guess-my-answer and 20 questions all work at home, on a call, or over text. The <a href='/would-you-rather-couples'>iLovu app</a> has a daily version so you never run out.")]),

  dict(slug="picnic-date-ideas", em_word="Picnic",
    title="Picnic Date Ideas — 12 Ideas Plus What to Pack | iLovu",
    desc="Picnic date ideas for couples &mdash; sunset picnics, indoor blanket picnics, beach and stargazing setups, plus exactly what to pack for a picnic date.",
    og="Picnic Date Ideas for Couples",
    eyebrow='<a href="/date-ideas">Date ideas</a> &middot; Picnic',
    h1='Picnic Date Ideas (and What to <em>Actually Pack</em>)',
    lead="A picnic is the perfect low-pressure date &mdash; cheap, unhurried, and easy to make feel special. Here are twelve picnic date ideas, plus what to bring so it isn't just sad sandwiches on the grass.",
    ideas=[("🌅","Sunset picnic","A blanket, snacks, and a spot facing west as the light goes gold.","Low cost"),
      ("🧺","Indoor picnic under the table","Rain outside? Blanket on the floor, fairy lights, juice in wine glasses.","Low cost"),
      ("🏖️","Beach picnic","Sand, sea, and a flask of something warm as the day cools.","Low cost"),
      ("📚","Park picnic and a book","Read to each other between bites. The most underrated picnic move.","Low cost"),
      ("🍰","Dessert-only picnic","Skip the meal &mdash; bring only puddings and rank them.","Low cost"),
      ("🥐","Breakfast picnic","Beat the crowds with an early one: pastries, fruit, coffee, sunrise.","Low cost"),
      ("🌍","Themed picnic","Pick a country and bring only its food, drink and playlist.","Medium"),
      ("⭐","Stargazing picnic","Head out after dark with blankets and hunt for constellations.","Free"),
      ("🧀","Wine and cheese board","A proper board, one nice bottle, no phones. Very little effort, feels fancy.","Medium"),
      ("🍽️","The fancy picnic","Real plates, cloth napkins, a candle. Turn the grass into a restaurant.","Medium"),
      ("🎲","Picnic and games","Pack a deck of cards or play <a href='/couple-games'>couple games</a> between courses.","Low cost"),
      ("🏙️","Rooftop picnic","A blanket, a view, and a warm evening breeze above the city.","Low cost")],
    faqs=[("What should you pack for a picnic date?","A blanket, easy finger food (cheese, fruit, bread, something sweet), a drink and cups, wet wipes, and a small speaker. Bonus points for a candle or fairy lights if it runs into the evening."),
      ("What food is good for a picnic date?","Things you can eat with your hands and share: a cheese and charcuterie board, fresh bread, grapes and strawberries, dips, and a couple of pastries or a dessert to finish. Keep it simple and shareable.")]),

  dict(slug="coffee-date-ideas", em_word="Coffee",
    title="Coffee Date Ideas — 10 Ideas for a Great Coffee Date | iLovu",
    desc="Coffee date ideas for couples and first dates &mdash; low-pressure ways to make a coffee date feel like more, from a caf&eacute; crawl to coffee-and-a-walk.",
    og="Coffee Date Ideas for Couples & First Dates",
    eyebrow='<a href="/date-ideas">Date ideas</a> &middot; Coffee',
    h1='Coffee Date Ideas That Beat Just <em>Sitting There</em>',
    lead="A coffee date is the classic low-pressure meet &mdash; easy to say yes to, easy to keep short or let run long. These coffee date ideas give you something to do beyond staring across the table.",
    ideas=[("☕","The caf&eacute; crawl","One drink at three different spots, rank them as you walk between.","Low cost"),
      ("🚶","Coffee and a walk","Grab coffees to go and wander. Walking side by side makes talking easier.","Low cost"),
      ("📚","Bookshop caf&eacute;","Coffee, then pick a book for each other in under five minutes.","Low cost"),
      ("💬","Coffee and question cards","Bring a few <a href='/questions-to-ask-your-partner'>good questions</a> and skip the small talk.","Low cost"),
      ("🎨","Latte art attempt","Find a caf&eacute; that lets you try pouring your own. Comedy guaranteed.","Low cost"),
      ("👀","People-watch and invent lives","Sit by the window and make up backstories for passers-by.","Low cost"),
      ("🎲","Board game caf&eacute;","Coffee plus a quick game you've never played turns a 30-minute date into two hours.","Low cost"),
      ("🏭","Roastery tour","Somewhere that roasts on site &mdash; smell everything, learn something, geek out.","Medium"),
      ("✏️","Sketch each other","Two napkins, two pens, ninety seconds each. Keep the worst.","Low cost"),
      ("🛍️","Coffee then a market","Caffeinate, then wander a market or a few shops with no agenda.","Low cost")],
    faqs=[("Is coffee a good first date?","Yes &mdash; a coffee date is low pressure, cheap and easy to leave or extend, which takes the stakes out of a first meet. Pick somewhere with a bit of atmosphere and something to do nearby."),
      ("What do you talk about on a coffee date?","Skip the interview. Ask open questions &mdash; favourite trips, what they're into lately, the best thing that happened this week. A few <a href='/questions-to-ask-your-partner'>questions to ask your partner</a> can carry the whole date.")]),

  dict(slug="second-date-ideas", em_word="Second Date",
    title="Second Date Ideas — 10 Great Ideas for the 2nd Date | iLovu",
    desc="Second date ideas that build on a good first date &mdash; a step more active and personal than coffee, from cooking together to mini golf, trivia and the 36 questions.",
    og="Second Date Ideas for Couples",
    eyebrow='<a href="/date-ideas">Date ideas</a> &middot; Second date',
    h1='Second Date Ideas That Build on a <em>Good First One</em>',
    lead="If the first date was coffee or drinks, the second is where you do something &mdash; a little more active, a little more personal. These second date ideas make it easy to keep the momentum.",
    ideas=[("🍳","Cook a meal together","Teamwork, a shared task, and something to laugh about if it goes wrong.","Low cost"),
      ("⛳","Mini golf","Low stakes, easy banter, a made-up trophy. Hard to have a bad time.","Low cost"),
      ("🧠","Trivia or pub quiz night","Team up and find out how your brains work together.","Low cost"),
      ("🥐","Farmers market wander","Graze, sample, and pick something to cook or eat later.","Low cost"),
      ("🖼️","Museum or gallery, then coffee","Wander somewhere interesting, then talk about it over a drink.","Low cost"),
      ("🌇","Sunset walk somewhere new","A walk lowers the pressure and the conversation just flows.","Free"),
      ("🎳","Arcade or bowling","Something to do with your hands and a scoreboard to tease over.","Low cost"),
      ("💬","The 36 questions","Bold for a second date, but the <a href='/36-questions'>36 questions</a> skip months of small talk.","Free"),
      ("🍷","Wine or coffee tasting","A guided tasting gives you built-in things to talk about.","Medium"),
      ("🧗","Try something active","A climbing wall or a class &mdash; being beginners together resets the nerves.","Medium")],
    faqs=[("What should you do on a second date?","Something a step more active and personal than the first &mdash; cook together, play mini golf, hit a trivia night, or wander a market. Doing an activity beats another sit-down drink for actually getting to know someone."),
      ("Is the second date important?","Often more than the first. The first proves there's a spark; the second shows whether you enjoy actually doing something together. Pick something with a shared activity so there's no pressure to fill silences.")]),
]
